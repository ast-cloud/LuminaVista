            ...
            <Box sx={{display:'flex', flexDirection:'row', height:'82vh', width:'100%', gap:2, border:'0px solid red'}}>
                <Box component='form' height={'auto'} width={'50%'} sx={{display:'flex', flexDirection:'column', flexBasis:'6'}}>
                    ...
                    <Box sx={{display:'flex', flexDirection:'row', gap:2, mb:2}}>
                            <TextField id='phone' label='Phone' size="small" fullWidth sx={{}}/>
                            <TextField select label='Preferred method of contact' name="pmoc" value={formData.pmoc} onChange={handleChange} InputLabelProps={{sx:{fontSize:'14px'}}} size="small" fullWidth sx={{flexGrow:1}}>
                                <MenuItem key={'Phone'} value={'Phone'}>Phone</MenuItem>
                                <MenuItem key={'E-mail'} value={'E-mail'}>E-mail</MenuItem>
                            </TextField>
                    </Box>
                    <Box sx={{display:'flex', flexDirection:'row', gap:2, mb:2}}>
                            <TextField select label='How can we help?' name="hcwh" value={formData.hcwh} onChange={handleChange} InputLabelProps={{sx:{fontSize:'14px'}}} size="small" fullWidth>
                            ...
                            <TextField select label='Area of interest' name="aoi" value={formData.aoi} onChange={handleChange} InputLabelProps={{sx:{fontSize:'14px'}}} size="small" fullWidth>
                    ...
                    <TextField label='Message' name="message" value={formData.message} onChange={handleChange} helperText='Write your message here' multiline minRows={4} sx={{mb:2}}/>
